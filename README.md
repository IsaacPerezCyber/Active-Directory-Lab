...
<h2>Description</h2>
This project will utlize oracle virutal machines in conjunction with Microsoft server 2019. I will configure a domain controller and install Remote Access Server for DHCP client. 
<br />
